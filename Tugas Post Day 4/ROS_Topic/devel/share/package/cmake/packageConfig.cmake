...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /root/TPOST4/ROS_Topic/src/package)
  set(package_DEVEL_PREFIX /root/TPOST4/ROS_Topic/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /root/TPOST4/ROS_Topic/install)
...
if(NOT "/root/TPOST4/ROS_Topic/devel/include " STREQUAL " ")
  set(package_INCLUDE_DIRS "")
  set(_include_dirs "/root/TPOST4/ROS_Topic/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/TPOST4/ROS_Topic/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/TPOST4/ROS_Topic/devel/lib;/root/TPOST4/ROS_Topic/devel/lib;/opt/ros/noetic/lib)
