...
class MagCalcRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagCalcRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagCalcRequest
    let len;
    let data = new MagCalcRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagCalcRequest(null);
...
class MagCalcResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagCalcResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagCalcResponse
    let len;
    let data = new MagCalcResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagCalcResponse(null);
...
module.exports = {
  Request: MagCalcRequest,
  Response: MagCalcResponse,
  md5sum() { return '55d1a215f43fd1f64eb105a505b172c4'; },
  datatype() { return 'package/MagCalc'; }
};
